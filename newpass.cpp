...
//      QString encDirPath = QCoreApplication::applicationDirPath() + QDir::separator() + "random";
//      QString encPath = directoryPath + QDir::separator() + "enc.txt";
...
//    QSqlQuery query;
//    query.prepare("CREATE TABLE IF NOT EXISTS credentials (id INTEGER PRIMARY KEY AUTOINCREMENT, username TEXT NOT NULL UNIQUE, site TEXT NOT NULL UNIQUE, password TEXT NOT NULL);");
